Locales['br'] = {
    ...
    ['robbery_cancelled_at'] = '~r~ o assalto será em: ~b~',
    ['robbery_has_cancelled'] = '~r~ O assalto foi cancelado: ~b~',
    ['already_robbed'] = 'esta loja foi roubada recentemente... por favor, espere: ',
    ['seconds'] = 'segundos.',
    ...
    ['min_police'] = 'necessário pelo menos ~b~',
    ['in_city'] = '~s~ policiais na cidade para executar assaltos.',
