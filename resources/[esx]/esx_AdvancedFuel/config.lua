...
settings["br"] = {
	...
	fuelError = "~r~Você não está no lugar correto.",
	buyFuel = "comprar combustível",
	liters = "litros",
	percent = "porcento",
	confirm = "Confirmar",
	fuelStation = "Posto de Gasolina",
	boatFuelStation = "Posto de Gasolina | Barcos",
	avionFuelStation = "Posto de Gasolina | Aviões ",
	heliFuelStation = "Posto de Gasolina | Helicópteros",
	getJerryCan = "pressione ~g~E~w~ para comprar um galão de combustível por: (R$"..petrolCanPrice..")",
