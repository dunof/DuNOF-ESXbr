...
Config.Map = {
  {name="Fazenda de Coca", 		color=6, scale=0.8, id=403, x=2448.9228515625,  y=1836.8076171875,  z=51.953701019287},
  ...
  {name="Laboratório de Meta",	color=6, scale=0.8, id=403, x=1525.298828125,   y=1710.0217285156,  z=109.00956726074},
  {name="Refino de Meta",  		color=6, scale=0.8, id=403, x=-1001.4151611328, y=4848.0087890625,  z=274.00686645508},
  ...
  {name="Fazenda de Maconha",	color=2, scale=0.8, id=140, x=1609.125,         y=6663.5942382813,  z=20.961572647095},
  {name="Refino de Maconha",	color=2, scale=0.8, id=140, x=91.061386108398,  y=3750.0380859375,  z=39.77326965332},
